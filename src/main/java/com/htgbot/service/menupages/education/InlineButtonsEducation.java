...
public class InlineButtonsEducation {
    ...
    public static List<String> getQuizGameButtonsCallbacks(TransData transData){
        ...
        if(numberOfQuiz == 1){
            ...
            System.out.println("ААЛО1");
            callbacks.add("OFFICIANT11");
            callbacks.add("OFFICIANT12");
            callbacks.add("OFFICIANT13");
            callbacks.add("OFFICIANT14");
            callbacks.add("OFFICIANT21");
            callbacks.add("OFFICIANT22");
            callbacks.add("OFFICIANT23");
            callbacks.add("OFFICIANT24");
            callbacks.add("OFFICIANT31");
            callbacks.add("OFFICIANT32");
            callbacks.add("OFFICIANT33");
            callbacks.add("OFFICIANT34");
            callbacks.add("OFFICIANT41");
            callbacks.add("OFFICIANT42");
            callbacks.add("OFFICIANT43");
            callbacks.add("OFFICIANT44");
            callbacks.add("OFFICIANT51");
            callbacks.add("OFFICIANT52");
            callbacks.add("OFFICIANT53");
            callbacks.add("OFFICIANT54");
            callbacks.add("OFFICIANT61");
            callbacks.add("OFFICIANT62");
            callbacks.add("OFFICIANT63");
            callbacks.add("OFFICIANT64");
            callbacks.add("OFFICIANT71");
            callbacks.add("OFFICIANT72");
            callbacks.add("OFFICIANT73");
            callbacks.add("OFFICIANT74");
            quizGameButtonsCallbacks = getCallbacksToListFromStatesList(transData, callbacks);
        } else if (numberOfQuiz == 2) {
            List<String> callbacks = new ArrayList<>();
            callbacks.add("BARMAN11");
            callbacks.add("BARMAN12");
            callbacks.add("BARMAN13");
            callbacks.add("BARMAN14");
            callbacks.add("BARMAN21");
            callbacks.add("BARMAN22");
            callbacks.add("BARMAN23");
            callbacks.add("BARMAN24");
            callbacks.add("BARMAN31");
            callbacks.add("BARMAN32");
            callbacks.add("BARMAN33");
            callbacks.add("BARMAN34");
            callbacks.add("BARMAN41");
            callbacks.add("BARMAN42");
            callbacks.add("BARMAN43");
            callbacks.add("BARMAN44");
            callbacks.add("BARMAN51");
            callbacks.add("BARMAN52");
            callbacks.add("BARMAN53");
            callbacks.add("BARMAN54");
            callbacks.add("BARMAN61");
            callbacks.add("BARMAN62");
            callbacks.add("BARMAN63");
            callbacks.add("BARMAN64");
            callbacks.add("BARMAN71");
            callbacks.add("BARMAN72");
            callbacks.add("BARMAN73");
            callbacks.add("BARMAN74");
            quizGameButtonsCallbacks = getCallbacksToListFromStatesList(transData, callbacks);
        } else if (numberOfQuiz == 3) {
            List<String> callbacks = new ArrayList<>();
            callbacks.add("COOK11");
            callbacks.add("COOK12");
            callbacks.add("COOK13");
            callbacks.add("COOK14");
            callbacks.add("COOK21");
            callbacks.add("COOK22");
            callbacks.add("COOK23");
            callbacks.add("COOK24");
            callbacks.add("COOK31");
            callbacks.add("COOK32");
            callbacks.add("COOK33");
            callbacks.add("COOK34");
            callbacks.add("COOK41");
            callbacks.add("COOK42");
            callbacks.add("COOK43");
            callbacks.add("COOK44");
            callbacks.add("COOK51");
            callbacks.add("COOK52");
            callbacks.add("COOK53");
            callbacks.add("COOK54");
            callbacks.add("COOK61");
            callbacks.add("COOK62");
            callbacks.add("COOK63");
            callbacks.add("COOK64");
            callbacks.add("COOK71");
            callbacks.add("COOK72");
            callbacks.add("COOK73");
            callbacks.add("COOK74");
            quizGameButtonsCallbacks = getCallbacksToListFromStatesList(transData, callbacks);
